...
class LisaandMotek2018SM(Behavior):
    ...
    def create(self):
        ...
        _state_machine.userdata.utter_complete = 'The gripper is finished'
        _state_machine.userdata.utter_incomplete = 'The gripper is not finished, tip: move on the gripper shared on the shared work space'
        _state_machine.userdata.utter_next_screw = 'move to next screw'
        ...
        # x:806 y:366, x:1441 y:144, x:1813 y:661, x:1529 y:516
        _sm_grip_ended_check_3 = OperatableStateMachine(outcomes=['fail', 'completed', 'screw_available', 'incomplete'], input_keys=['next_trajectory', 'insertion_successful', 'screw_found', 'utter_incomplete', 'utter_next_screw', 'utter_complete'], output_keys=['list_available_screw_poses'])
        ...
        with _sm_grip_ended_check_3:
            ...
            OperatableStateMachine.add('Available Screw In current Gripper',
                                        ...
                                        transitions={'succeeded': 'exit_next_screw', 'aborted': 'Ask for Gripper Complete'},
            ...
            OperatableStateMachine.add('Fix for screwed but not found',
                                        ...
                                        transitions={'found_and_inserted': 'lof_after_inserted', 'not_inserted': 'Utter Wrong Insertion'},
            ...
            # x:493 y:12
            OperatableStateMachine.add('afater screw found',
                                        LogKeyState(text="After screw found is {}", severity=Logger.REPORT_HINT),
            ...
            OperatableStateMachine.add('check answer',
                                        CheckConditionState(predicate=lambda x: x == "yes" or x == "complete"),
                                        transitions={'true': 'utter_exit_complete', 'false': 'reset_gripper'},
                                        autonomy={'true': Autonomy.Off, 'false': Autonomy.Off},
                                        remapping={'input_value': 'answer'})

            # x:1471 y:753
            OperatableStateMachine.add('exit_next_screw',
                                        LisaUtterState(context_id=None, wait_time=0, suspend_time=0),
                                        transitions={'done': 'screw_available', 'preempt': 'screw_available', 'timeouted': 'screw_available', 'error': 'fail'},
                                        autonomy={'done': Autonomy.Off, 'preempt': Autonomy.Off, 'timeouted': Autonomy.Off, 'error': Autonomy.Off},
                                        remapping={'text_to_utter': 'utter_next_screw', 'error_reason': 'error_reason'})

            # x:1011 y:524
            OperatableStateMachine.add('exit_reset',
                                        LogState(text="DBG-EXIT: incomplete, gripper resetted", severity=Logger.REPORT_HINT),
                                        transitions={'done': 'utter exit incomplete'},
                                        autonomy={'done': Autonomy.Off})

            # x:1179 y:17
            OperatableStateMachine.add('is_gripper_complete',
                                        CheckGripperIsFinished(number_part_screws=4),
                                        transitions={'done': 'utter_exit_complete', 'screws_available': 'Available Screw In current Gripper', 'operator_check': 'reset_gripper', 'error': 'fail'},
            ...
            # x:328 y:20
            OperatableStateMachine.add('lof_after_inserted',
                                        LogKeyState(text="After inserted is {}", severity=Logger.REPORT_HINT),
                                        transitions={'done': 'afater screw found'},
                                        autonomy={'done': Autonomy.Off},
                                        remapping={'data': 'insertion_successful'})
            ...
            OperatableStateMachine.add('reset_gripper',
                                        ...
                                        transitions={'succeeded': 'exit_reset', 'aborted': 'fail', 'nothing_to_do': 'utter_exit_complete'},
            ...
            # x:1217 y:493
            OperatableStateMachine.add('utter exit incomplete',
                                        LisaUtterState(context_id=None, wait_time=10, suspend_time=2),
                                        transitions={'done': 'incomplete', 'preempt': 'incomplete', 'timeouted': 'incomplete', 'error': 'fail'},
                                        autonomy={'done': Autonomy.Off, 'preempt': Autonomy.Off, 'timeouted': Autonomy.Off, 'error': Autonomy.Off},
                                        remapping={'text_to_utter': 'utter_incomplete', 'error_reason': 'error_reason'})

            # x:1167 y:126
            OperatableStateMachine.add('utter_exit_complete',
                                        LisaUtterState(context_id=None, wait_time=0, suspend_time=0),
                                        transitions={'done': 'completed', 'preempt': 'completed', 'timeouted': 'completed', 'error': 'fail'},
                                        autonomy={'done': Autonomy.Off, 'preempt': Autonomy.Off, 'timeouted': Autonomy.Off, 'error': Autonomy.Off},
                                        remapping={'text_to_utter': 'utter_complete', 'error_reason': 'error_reason'})
            ...
            OperatableStateMachine.add('Ask for Gripper Complete',
                                        ...
                                        transitions={'finished': 'log_answer', 'failed': 'fail', 'max_retry': 'reset_gripper'},
        ...
        with _state_machine:
            ...
            OperatableStateMachine.add('Grip Ended Check',
                                        ...
                                        remapping={'next_trajectory': 'next_trajectory', 'insertion_successful': 'insertion_successful', 'screw_found': 'screw_found', 'utter_incomplete': 'utter_incomplete', 'utter_next_screw': 'utter_next_screw', 'utter_complete': 'utter_complete', 'list_available_screw_poses': 'list_available_screw_poses'})
